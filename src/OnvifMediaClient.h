...
public:
	...
	Response<_trt__AddVideoAnalyticsConfigurationResponse> AddVideoAnalyticsConfiguration(Request<_trt__AddVideoAnalyticsConfiguration> &rRequest);
	...
	Response<_trt__RemoveVideoEncoderConfigurationResponse> RemoveVideoEncoderConfiguration(Request<_trt__RemoveVideoEncoderConfiguration> &rRequest);
	Response<_trt__RemoveVideoSourceConfigurationResponse> RemoveVideoSourceConfiguration(Request<_trt__RemoveVideoSourceConfiguration> &rRequest);
	Response<_trt__RemoveAudioEncoderConfigurationResponse> RemoveAudioEncoderConfiguration(Request<_trt__RemoveAudioEncoderConfiguration> &rRequest);
	Response<_trt__RemoveAudioSourceConfigurationResponse> RemoveAudioSourceConfiguration(Request<_trt__RemoveAudioSourceConfiguration> &rRequest);
	Response<_trt__RemovePTZConfigurationResponse> RemovePTZConfiguration(Request<_trt__RemovePTZConfiguration> &rRequest);
	Response<_trt__RemoveVideoAnalyticsConfigurationResponse> RemoveVideoAnalyticsConfiguration(Request<_trt__RemoveVideoAnalyticsConfiguration> &rRequest);
	...
	Response<_trt__RemoveAudioOutputConfigurationResponse> RemoveAudioOutputConfiguration(Request<_trt__RemoveAudioOutputConfiguration> &rRequest);
	Response<_trt__RemoveAudioDecoderConfigurationResponse> RemoveAudioDecoderConfiguration(Request<_trt__RemoveAudioDecoderConfiguration> &rRequest);
	...
	Response<_trt__GetVideoEncoderConfigurationsResponse> GetVideoEncoderConfigurations(Request<_trt__GetVideoEncoderConfigurations> &rRequest);
	...
	Response<_trt__GetAudioEncoderConfigurationsResponse> GetAudioEncoderConfigurations(Request<_trt__GetAudioEncoderConfigurations> &rRequest);
	Response<_trt__GetVideoAnalyticsConfigurationsResponse> GetVideoAnalyticsConfigurations(Request<_trt__GetVideoAnalyticsConfigurations> &rRequest);
	...
	Response<_trt__GetAudioDecoderConfigurationsResponse> GetAudioDecoderConfigurations(Request<_trt__GetAudioDecoderConfigurations> &rRequest);
	...
	Response<_trt__GetVideoAnalyticsConfigurationResponse> GetVideoAnalyticsConfiguration(Request<_trt__GetVideoAnalyticsConfiguration> &rRequest);
	...
	Response<_trt__GetCompatibleVideoEncoderConfigurationsResponse> GetCompatibleVideoEncoderConfigurations(Request<_trt__GetCompatibleVideoEncoderConfigurations> &rRequest);
	Response<_trt__GetCompatibleVideoSourceConfigurationsResponse> GetCompatibleVideoSourceConfigurations(Request<_trt__GetCompatibleVideoSourceConfigurations> &rRequest);
	Response<_trt__GetCompatibleAudioEncoderConfigurationsResponse> GetCompatibleAudioEncoderConfigurations(Request<_trt__GetCompatibleAudioEncoderConfigurations> &rRequest);
	Response<_trt__GetCompatibleAudioSourceConfigurationsResponse> GetCompatibleAudioSourceConfigurations(Request<_trt__GetCompatibleAudioSourceConfigurations> &rRequest);
	Response<_trt__GetCompatibleVideoAnalyticsConfigurationsResponse> GetCompatibleVideoAnalyticsConfigurations(Request<_trt__GetCompatibleVideoAnalyticsConfigurations> &rRequest);
	Response<_trt__GetCompatibleMetadataConfigurationsResponse> GetCompatibleMetadataConfigurations(Request<_trt__GetCompatibleMetadataConfigurations> &rRequest);
	Response<_trt__GetCompatibleAudioOutputConfigurationsResponse> GetCompatibleAudioOutputConfigurations(Request<_trt__GetCompatibleAudioOutputConfigurations> &rRequest);
	Response<_trt__GetCompatibleAudioDecoderConfigurationsResponse> GetCompatibleAudioDecoderConfigurations(Request<_trt__GetCompatibleAudioDecoderConfigurations> &rRequest);
	...
	Response<_trt__SetVideoAnalyticsConfigurationResponse> SetVideoAnalyticsConfiguration(Request<_trt__SetVideoAnalyticsConfiguration> &rRequest);
	...
	Response<_trt__GetVideoSourceConfigurationOptionsResponse> GetVideoSourceConfigurationOptions(Request<_trt__GetVideoSourceConfigurationOptions> &rRequest);
	Response<_trt__GetVideoEncoderConfigurationOptionsResponse> GetVideoEncoderConfigurationOptions(Request<_trt__GetVideoEncoderConfigurationOptions> &rRequest);
	Response<_trt__GetAudioSourceConfigurationOptionsResponse> GetAudioSourceConfigurationOptions(Request<_trt__GetAudioSourceConfigurationOptions> &rRequest);
	Response<_trt__GetAudioEncoderConfigurationOptionsResponse> GetAudioEncoderConfigurationOptions(Request<_trt__GetAudioEncoderConfigurationOptions> &rRequest);
	Response<_trt__GetMetadataConfigurationOptionsResponse> GetMetadataConfigurationOptions(Request<_trt__GetMetadataConfigurationOptions> &rRequest);
	Response<_trt__GetAudioOutputConfigurationOptionsResponse> GetAudioOutputConfigurationOptions(Request<_trt__GetAudioOutputConfigurationOptions> &rRequest);
	Response<_trt__GetAudioDecoderConfigurationOptionsResponse> GetAudioDecoderConfigurationOptions(Request<_trt__GetAudioDecoderConfigurationOptions> &rRequest);
	Response<_trt__GetGuaranteedNumberOfVideoEncoderInstancesResponse> GetGuaranteedNumberOfVideoEncoderInstances(Request<_trt__GetGuaranteedNumberOfVideoEncoderInstances> &rRequest);
