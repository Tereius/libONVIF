...
int PTZBindingService::dispatch(struct soap* soap)
{
	...
	if ((!soap->action && !soap_match_tag(soap, soap->tag, "tptz:GeoMove")) || (soap->action && !strcmp(soap->action, "http://www.onvif.org/ver20/ptz/wsdl/GeoMove")))
	...
	if ((!soap->action && !soap_match_tag(soap, soap->tag, "tptz:GetCompatibleConfigurations")) || (soap->action && !strcmp(soap->action, "http://www.onvif.org/ver20/ptz/wsdl/GetCompatibleConfigurations")))
